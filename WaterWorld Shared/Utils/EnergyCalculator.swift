...
class EnergyCalculator {
    ...
    /// Maximum net energy loss per tick: movement cost + idle cost in total darkness.
    var maxLossPerTick: Double { GlobalConstants.movementEnergyLoss + GlobalConstants.idleEnergyLoss }
